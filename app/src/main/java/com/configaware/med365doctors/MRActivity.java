 ...
 */
public class MRActivity extends ActionBarActivity implements
        ...
        if (mCurrentLocation != null) {
            ...
            if(!mydb.isEmpty())
            {
                ...
                if (result!=null){
                    result.moveToFirst();
                    do{
                        new updateLocation(MRActivity.this,mLastUpdateTimeTextView).execute(result.getString(1), result.getString(2), String.valueOf(mCurrentLocation.getLatitude()),String.valueOf(mCurrentLocation.getLongitude()));
                        Log.e("Location Data", result.getString(1)+" "+result.getString(2));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            Toast.makeText(MRActivity.this,"Logged Out",Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(MRActivity.this,Splash.class);
            startActivity(intent);
            finish();
            return true;
        }
